...
if __name__ == '__main__':
    ...
    execute_func_for_many_experiments_and_combine([
        'humanoid_run_RandomSearch_pop12',
        'humanoid_run_PBTNAS_pop12_mutation',
        'humanoid_run_PBTNAS_pop12',
        ...
        ylim=(0, 350),
        show_title=False,
        legend_inside = True, marker_style = '-', figsize = (6, 4),
        metric_name_pretty = 'Score',
        value_to_add_at_0 = 0, epoch_to_frames_mul = 10 ** 4 * 12, save_format='pdf'
    )

    # Soups:
    execute_func_for_all_runs_and_combine('humanoid_run_PBTNAS_pop12',
