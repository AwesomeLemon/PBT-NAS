"""
Note: I copied this from the Python codebase, and commented the registering of shared_memory with
      resourse tracker, because otherwise it is prone to freeing the memory when I still need it
      See:
      ...
      (plus, I added destructors/finalizers for debugging but commented them out after that)
...
class SharedMemory:
    ...
    def __init__(self, name=None, create=False, size=0):
        ...
        # self._finalizer = weakref.finalize(self, SharedMemory.destructor, name)

    # @staticmethod
    # def destructor(name):
    #     print(f'SHM destructor {name}')
...
class ShareableList:
    ...
    def __init__(self, sequence=None, *, name=None):
        ...
        # self._finalizer = weakref.finalize(self, print, f'SL destructor {name}')
